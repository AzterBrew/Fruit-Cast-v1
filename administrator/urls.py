...
urlpatterns = [
    ...
    path('transaction/<int:transaction_id>/flag/', views.flag_transaction, name='flag_transaction'),
    path('admin_dashboard/', admin_dashboard, name='admin_dashboard'),
    path('show_allaccounts/', show_allaccounts, name='show_allaccounts'),
    path('admin_account_detail/<int:account_id>/', views.admin_account_detail, name='admin_account_detail'),
    ...
    path('harvest_verified/<int:record_id>/view/', views.admin_harvestverified_view, name='admin_harvestverified_view'),
    path('harvest_verified/<int:record_id>/edit/', views.admin_harvestverified_edit, name='admin_harvestverified_edit'),
